      ...
      <div class="w">
          ...
          <c:forEach items="${requestScope.page.list}" var="book">
            <tr>
              ...
              <td>
                ...
                <a id="${book.title}" href="BookManagerServlet?methodName=deleteBookById&bookId=${book.id}" class="del">删除</a>
              </td>
            </tr>
          </c:forEach>
        ...
        <div class="footer">
          ...
          <c:if test="${requestScope.page.pageNo > 1}">
            <div><a href="BookManagerServlet?methodName=getPageBooks&pageNo=1">首页</a></div>
            <div><a href="BookManagerServlet?methodName=getPageBooks&pageNo=${requestScope.page.pageNo - 1}">上一页</a></div>
          </c:if>
            <ul>
...
<%--                <li class="active">${index}</li>--%>
                  <li>
                    <a class="active" style="color: red" href="BookManagerServlet?methodName=getPageBooks&pageNo=${index}">${index}</a>
                  </li>
              </c:if>
              <c:if test="${requestScope.page.pageNo != index}">
                <li>
            ...
            <c:if test="${requestScope.page.pageNo < requestScope.page.totalPageNo}">
              <div><a href="BookManagerServlet?methodName=getPageBooks&pageNo=${requestScope.page.pageNo + 1}">下一页</a></div>
              <div><a href="BookManagerServlet?methodName=getPageBooks&pageNo=${requestScope.page.totalPageNo}">末页</a></div>
            </c:if>
