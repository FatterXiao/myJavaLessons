  ...
  <body>
    <div class="header">
      <div class="w">
        ...
        <div class="header-right">
          <a href="../manager/book_manager.jsp" class="order">图书管理</a>
          <a href="../manager/order_manager.jsp" class="destory">订单管理</a>
    ...
    <div class="login_banner">
      <div class="register_form">
        <form action="bookManageServlet?action=reflashBook&bookId=${requestScope.book.id}" method="post">
          <div class="form-item">
            <div>
              <label>名称:</label>
