            ...
            <div class="list">
                <div class="list-header">
                    ...
                    <div class="price-search">
                        <form action="bookClientServlet?action=getIndexPageBooksByPrice&pageNo=${requestScope.pageBooks.pageNo}" method="post">
                            <span>价格:</span>
                ...
                <div class="list-footer">
                    <div><a href="bookClientServlet?action=getIndexPageBooksByPrice&pageNo=1&lowPrice=${requestScope.lowPrice}&highPrice=${requestScope.highPrice}">首页</a></div>
                    <div>
                    ...
                    <div><a href="bookClientServlet?action=getIndexPageBooksByPrice&pageNo=${requestScope.pageBooks.totalNos}&lowPrice=${requestScope.lowPrice}&highPrice=${requestScope.highPrice}">末页</a>
                    </div>
